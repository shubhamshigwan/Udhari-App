...
//to add money to transaction table
if ( isset($_POST['p_id']) && isset($_POST['s_id']) 
     && isset($_POST['moneey'])) {
    $sql = "INSERT INTO transc (p_id, s_id, moneey) 
              VALUES (:p_id, :s_id, :moneey)";
...
$stmt = $pdo->query("SELECT p_id, s_id, moneey FROM transc");
$rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <div class="container">
        ...
        <div class="my-5 p-3 orange">
            <h4>Add Customer</h4>
            <form action="post">
                <div class="row">
                    <div class="col-5 my-2">
                      <input type="text" name="p_id" class="form-control" placeholder="CustomerID" aria-label="First name">
                    </div>
                    <div class="col-5 my-2">
                      <input type="text" name="moneey" class="form-control" placeholder="Amount" aria-label="Last name">
                    </div>
