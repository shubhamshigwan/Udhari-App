...
if ( isset($_POST['sname']) && isset($_POST['oname']) 
     && isset($_POST['smobile']) && isset($_POST['passw'])) {
    $sql = "INSERT INTO shop (sname, oname, smobile, passw) 
              VALUES (:sname, :oname, :smobile, :passw)";
...
$stmt = $pdo->query("SELECT sname, oname, smobile, s_id FROM shop");
...
<body>
    ...
    <div class="container ">
        <center>
            <h1 class="my-4">Shop Registration</h1>
        </center>
        <div class="container orange my-5">
            <form method="post">
                <div class="m-3 py-3">
                    <h3>Shop Name</h3>
                ...
                <div class="m-3 py-3">
                    <h3>Owner Mobile</h3>
                    <input type="text" name="smobile" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
